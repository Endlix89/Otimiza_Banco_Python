...
class Conta:
    ...
    def sacar(self, valor):
        ...
        if excedeu_saldo:
          print("\n Operação Falhou! Saldo insufinciente.")
    ...
    def sacar(self, valor):
        ...
        if excedeu_limite:
          ...
          return False 
           ...
           print("\n Operação Falhou! Numero de saque excedido.")
...
class Deposito(Trasacao):
   ...
   def registrar(self, conta):
      ...
      if sucesso_transacao:
         conta.historico_transacao(self)
  ...
  while True:
     ...
     if opcao == "d":
      ...
      break
        ...
        print("\n Operação invalida, por favor selecione a operação desejada.")
